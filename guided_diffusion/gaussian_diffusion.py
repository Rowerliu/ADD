...
from .fourier_trans import image_fourier_trans
...
class GaussianDiffusion:
    ...
    def fourier_frequency_list_loop(
            self,
            model,
            image,
            clip_denoised=True,
        ...
        return out_fourier_magnitude_list[::-1]

    def fourier_frequency_list_progressive(
            self,
            model,
            image,
            clip_denoised=True,
